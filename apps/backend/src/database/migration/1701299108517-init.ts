...
export class Init1701299108517 implements MigrationInterface {
    name = 'Init1701299108517'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."trainings_duration_enum" AS ENUM('low', 'normal', 'hi', 'extra')`);
